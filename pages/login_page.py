...
class LoginPage:
    ...
    Locators are chosen by what the user sees - the placeholder text and the
    button's own label - rather than by CSS class. A class like `.btn_action`
    describes how the page is styled, and changes when someone restyles it; the
    word "Login" on the button changes only when the product changes.
    """
    ...
    def error_message(self) -> str:
        ...
        correct - a page object that asserts makes every caller share one
